        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center space-x-4">
            ...
            <div>
              ...
              <p className="text-xs text-gray-500 dark:text-gray-500">Last active: {user.lastActive}</p>
            </div>
          </div>
          
          <div className="grid grid-cols-2 gap-4 text-center">
            <div className="bg-white dark:bg-gray-900 rounded-lg p-3 border border-gray-200 dark:border-gray-700">
              <div className="text-2xl font-semibold text-gray-900 dark:text-white">{user.activeTasks}</div>
        ...
        <div className="grid grid-cols-4 gap-4 mt-4">
          <div className="bg-white dark:bg-gray-900 rounded-lg p-3 text-center border border-gray-200 dark:border-gray-700">
            <div className="flex items-center justify-center space-x-1 mb-1">
              ...
              <span className="text-sm font-medium text-gray-900 dark:text-white">{user.totalTasks}</span>
            </div>
          ...
          <div className="bg-white dark:bg-gray-900 rounded-lg p-3 text-center border border-gray-200 dark:border-gray-700">
            <div className="flex items-center justify-center space-x-1 mb-1">
              ...
              <span className="text-sm font-medium text-gray-900 dark:text-white">{user.completedTasks}</span>
            </div>
          ...
          <div className="bg-white dark:bg-gray-900 rounded-lg p-3 text-center border border-gray-200 dark:border-gray-700">
            <div className="flex items-center justify-center space-x-1 mb-1">
              ...
              <span className="text-sm font-medium text-gray-900 dark:text-white">{user.overdueTasks}</span>
            </div>
          ...
          <div className="bg-white dark:bg-gray-900 rounded-lg p-3 text-center border border-gray-200 dark:border-gray-700">
            <div className="flex items-center justify-center space-x-1 mb-1">
              ...
              <span className="text-sm font-medium text-gray-900 dark:text-white">{user.totalHoursThisWeek}h</span>
            </div>
